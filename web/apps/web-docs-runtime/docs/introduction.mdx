...
**TL;DR:** Igris is a governed execution engine for AI workloads. It executes with secure defaults, enforced resource limits, deterministic execution envelopes, and telemetry-backed observability — whether running in cloud, edge, or air-gapped environments.
