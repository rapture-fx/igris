...
**TL;DR:** Igris Runtime keeps your AI running even when the internet doesn't. Deploy AI anywhere—datacenter, edge device, or air-gapped environment—with automatic fallback to local models when cloud providers are unreachable.
...
One system. Cloud when available. Local models as fallback. Zero downtime.
...
- **GitHub:** [github.com/igris-inertial/igris-runtime](https://github.com/igris-inertial/igris-runtime)
- **Issues:** [Report bugs and request features](https://github.com/igris-inertial/igris-runtime/issues)
