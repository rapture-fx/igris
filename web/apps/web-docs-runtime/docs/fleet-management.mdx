...
**Features:**
- Real-time instance status across all regions
- Performance metrics (CPU, memory, latency)
- Request throughput and error rates
- Health indicators and alerts
- Instance details and logs

**Currently**: Dashboard uses mock data (see [Dashboard Audit Report](/DASHBOARD_AUDIT_REPORT.md))

**Roadmap**: Full integration with Overture `/v1/fleet/*` endpoints (Q1 2026)
...
**Total bandwidth:** <1 KB/s per instance
