...
**ROS2 Integration** ([igris-ros2](https://github.com/igris-inertial/igris-runtime)):
- DDS pub/sub messaging
- Nav2 autonomous navigation
- Multi-robot coordination

**Sensor & Actuator Tooling** ([igris-sensors](https://github.com/igris-inertial/igris-runtime)):
- GPIO control (Raspberry Pi)
- Camera interfaces
- LIDAR integration

**Safety & Certification** ([igris-safety](https://github.com/igris-inertial/igris-runtime)):
- Watchdog timers
- Safety modes (Normal/FailSafe/EmergencyStop)
- ISO 26262 / IEC 61508 hooks
- Audit logging

**Swarm Coordination** ([igris-swarm](https://github.com/igris-inertial/igris-runtime)):
- Raft-style leader election
- Distributed task voting
- Conflict resolution

**Fleet Management** ([igris-fleet](https://github.com/igris-inertial/igris-runtime)):
...
**Federated Learning** ([igris-federated](https://github.com/igris-inertial/igris-runtime)):
- Privacy-preserving collaborative learning
- QLoRA aggregation (4 strategies)
- Differential privacy
- Secure aggregation

**Dynamic Model Manager** ([igris-model-manager](https://github.com/igris-inertial/igris-runtime)):
- Task-based model selection
- Hot-swapping (< 200ms)
- LRU unloading
- Usage analytics

**Human-in-the-Loop** ([igris-hitl](https://github.com/igris-inertial/igris-runtime)):
- Approval workflows
- Auto-approve thresholds
- Context snapshots
- REST API integration

**Simulation & Testing** ([igris-simulation](https://github.com/igris-inertial/igris-runtime)):
