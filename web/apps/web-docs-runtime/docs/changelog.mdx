...
## [1.9.0] - 2025-12-21 ✨ Advanced Intelligence & Scale

**What's New:** Train AI across devices, switch models automatically, add human oversight, and test with chaos engineering.
...
## [1.8.0] - 2025-12-20 🤖 Robotics & Industrial AI

**What's New:** Control robots, connect to ROS2, deploy in safety-critical environments, manage device fleets.
...
Control hundreds of edge devices from one dashboard.
...
**Example:** Deploy new AI model to 50 warehouse robots simultaneously.

---

## [1.7.0] - 2025-12-18 ⚡ Core Reliability & Performance

**What's New:** Faster inference, persistent memory, better error handling, multi-modal support.
...
### Vision & Audio Input (Beta)

Send images and audio to your AI.

**Early support for:**
- Image analysis (ready for OpenCV integration)
- Audio transcription (ready for Whisper integration)
- Base64 encoding for API transmission

**Status:** Foundation in place, full integration coming soon.
