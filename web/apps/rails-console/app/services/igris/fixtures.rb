      ...
      [
        {
          ...
          target_label: 'Resend (hosted API)',
        ...
        },
        {
          ...
          name: 'create_invoice',
          target_type: 'webhook',
          target_label: 'Stripe webhook',
          policy: 'Single-flight per customer, manual review on >$5k',
          replay: 'Off',
        ...
        },
        {
          ...
          target_label: 'Local runtime (needs install)',
        ...
        },
        {
          ...
          name: 'refund_charge',
          target_type: 'hosted_api',
          target_label: 'Stripe (hosted API)',
