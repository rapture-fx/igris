...
const MOCK_ALERTS: SystemAlert[] = [
  {
    id: 'alrt_0001',
    timestamp: new Date(_now - 2 * 60_000).toISOString(),
    alert_type: 'PolicyViolationBurst',
    severity: 'critical',
    category: 'policy',
    source: 'containment-enforcer',
    message: 'Policy violation burst detected: 5 violations in 60s on exec_b1c2d3e4f5a6',
    status: 'open',
    execution_id: 'exec_b1c2d3e4f5a6',
  ...
  {
    id: 'alrt_0002',
    timestamp: new Date(_now - 7 * 60_000).toISOString(),
    alert_type: 'HighLatencyProvider',
    severity: 'warning',
    category: 'routing',
    source: 'inference-router',
    message: 'Provider latency p99 exceeded 800ms threshold: openai avg 912ms (last 5m)',
    status: 'acknowledged',
    provider: 'openai',
    acknowledged_by: 'ops-auto',
    acknowledged_at: new Date(_now - 5 * 60_000).toISOString(),
  },
  {
    id: 'alrt_0003',
    timestamp: new Date(_now - 14 * 60_000).toISOString(),
    alert_type: 'DeviceHeartbeatLost',
    severity: 'warning',
    category: 'fleet',
    source: 'control-plane',
    message: 'Device dev_a1b2c3d4 missed 3 consecutive heartbeats — may be offline',
    status: 'open',
    device_id: 'dev_a1b2c3d4',
  },
  {
    id: 'alrt_0004',
    timestamp: new Date(_now - 22 * 60_000).toISOString(),
    alert_type: 'ExecutionBudgetExceeded',
    severity: 'critical',
    category: 'cost',
    source: 'cost-governor',
    message: 'Execution token budget exceeded: 48,200 tokens used, limit 40,000',
    status: 'resolved',
    execution_id: 'exec_e7f8a9b0c1d2',
    agent_id: 'agent_0xd1e2f3',
    device_id: 'dev_9f3a2c1b',
    provider: 'deepseek',
    resolved_by: 'cost-governor',
    resolved_at: new Date(_now - 18 * 60_000).toISOString(),
  },
  {
    id: 'alrt_0005',
    timestamp: new Date(_now - 31 * 60_000).toISOString(),
    alert_type: 'MemoryQuotaWarning',
    severity: 'warning',
    category: 'execution',
    source: 'runtime-monitor',
    message: 'Memory usage at 89% of quota on exec_c3d4e5f6a7b8 (342MB / 384MB)',
    status: 'resolved',
    execution_id: 'exec_c3d4e5f6a7b8',
    agent_id: 'agent_0x1a2b3c',
    device_id: 'dev_f7e8d9c0',
    policy_rule: 'max_memory_mb',
    resolved_by: 'runtime-monitor',
    resolved_at: new Date(_now - 27 * 60_000).toISOString(),
  },
  {
    id: 'alrt_0006',
    timestamp: new Date(_now - 38 * 60_000).toISOString(),
    alert_type: 'NetworkEgressBlocked',
    severity: 'critical',
    category: 'policy',
    source: 'containment-enforcer',
    message: 'Network egress blocked and execution terminated: host not in allowlist',
    status: 'resolved',
    execution_id: 'exec_e7f8a9b0c1d2',
    agent_id: 'agent_0xd1e2f3',
    device_id: 'dev_9f3a2c1b',
    policy_rule: 'allow_network_egress',
    resolved_by: 'containment-enforcer',
    resolved_at: new Date(_now - 37 * 60_000).toISOString(),
  },
  {
    id: 'alrt_0007',
    timestamp: new Date(_now - 44 * 60_000).toISOString(),
    alert_type: 'RoutingFallback',
    severity: 'info',
    category: 'routing',
    source: 'inference-router',
    message: 'Primary provider anthropic unavailable — routed to fallback mistral',
    status: 'resolved',
    provider: 'anthropic',
    resolved_by: 'inference-router',
    resolved_at: new Date(_now - 43 * 60_000).toISOString(),
  },
  {
    id: 'alrt_0008',
    timestamp: new Date(_now - 52 * 60_000).toISOString(),
    alert_type: 'FleetCapacityLow',
    severity: 'warning',
    category: 'fleet',
    source: 'control-plane',
    message: 'Active device count dropped below minimum: 3 active (minimum 5)',
    status: 'acknowledged',
    acknowledged_by: 'ops-auto',
    acknowledged_at: new Date(_now - 50 * 60_000).toISOString(),
  },
  {
    id: 'alrt_0009',
    timestamp: new Date(_now - 61 * 60_000).toISOString(),
    alert_type: 'CostRateSpiking',
    severity: 'warning',
    category: 'cost',
    source: 'cost-governor',
    message: 'Hourly cost rate 2.4× above 7-day average ($0.82/hr vs $0.34/hr baseline)',
    status: 'open',
    provider: 'openai',
  },
  {
    id: 'alrt_0010',
    timestamp: new Date(_now - 75 * 60_000).toISOString(),
    alert_type: 'PolicyHashMismatch',
    severity: 'critical',
    category: 'policy',
    source: 'containment-enforcer',
    message: 'Policy hash mismatch on device dev_c8d9e0f1 — policy file may have been tampered',
    status: 'resolved',
    device_id: 'dev_c8d9e0f1',
    policy_rule: 'policy_integrity_check',
    resolved_by: 'ops-manual',
    resolved_at: new Date(_now - 68 * 60_000).toISOString(),
  },
];
