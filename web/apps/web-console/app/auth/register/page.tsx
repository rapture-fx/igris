      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center px-8 py-12">
        <div className="w-full max-w-md" style={{ backgroundColor: '#f6f6f4' }}>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              <label htmlFor="tenantName" className="block text-sm mb-2 font-inter" style={{ color: '#000000' }}>
                Organization Name
              </label>
              <input
                type="text"
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-sm mb-2 font-inter" style={{ color: '#000000' }}>
                Confirm Password
              </label>
              <input
                type="password"
