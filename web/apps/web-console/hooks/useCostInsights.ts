  ...
  return useQuery<OvertureUsageHistoryResponse>({
    ...
    queryFn: async () => {
      try {
        ...
        return { history, count: months } as OvertureUsageHistoryResponse;
      }
    },
  ...
  return useQuery<OvertureCostAnalyticsResponse>({
    ...
    queryFn: async () => {
      try {
        ...
        } as OvertureCostAnalyticsResponse;
      }
    },
    staleTime: 60 * 1000, // 1 minute
    retry: false,
    ...
    queryFn: async () => {
      try {
        ...
        return {
          ...
          time_window: window,
          generated_at: new Date().toISOString(),
        } as OvertureProviderStatsResponse;
      }
    },
    staleTime: 60 * 1000, // 1 minute
    retry: false,
  ...
  return useQuery<OvertureCostTrendResponse>({
    ...
    queryFn: async () => {
      try {
        ...
        // Mock data fallback - generate 24 hourly data points
        ...
        return { window, interval, trend } as OvertureCostTrendResponse;
      }
    },
    staleTime: 60 * 1000, // 1 minute
    retry: false,
  ...
  return useQuery<OvertureRoutingStatsResponse>({
    ...
    queryFn: async () => {
      try {
        ...
        } as OvertureRoutingStatsResponse;
      }
    },
    staleTime: 60 * 1000, // 1 minute
    retry: false,
    ...
    queryFn: async () => {
      try {
        ...
        return {
          ...
          count: 3,
        } as OvertureProviderLeaderboardResponse;
      }
    },
