    ...
    <div className="space-y-3">
      <div className="flex items-stretch gap-2">
        <div className="flex-1 min-w-0">
          <div className="text-[10px] text-gray-400 mb-1">prev_hash</div>
          <div className={cn(
            ...
            {prevHash || <span className="text-gray-300 italic">none</span>}
          </div>
        </div>

        <div className="flex items-center justify-center mt-5 flex-shrink-0">
          <span className={cn('text-xs', status === 'broken' ? 'text-red-400' : 'text-gray-300')}>→</span>
        </div>

        <div className="flex-1 min-w-0">
          <div className="text-[10px] text-gray-400 mb-1">hash</div>
          <div className="px-2.5 py-2 rounded border border-gray-200 dark:border-border bg-gray-50 dark:bg-muted text-[10px] text-gray-600 dark:text-muted-foreground break-all leading-relaxed">
            {hash}
          </div>
        </div>
      </div>
