    ...
    <div className="space-y-3">
      <div className="flex items-stretch gap-2">
        ...
        <div className="flex items-center justify-center mt-5 flex-shrink-0">
          <div className={cn('text-xs', status === 'broken' ? 'text-red-400' : 'text-gray-300')}>
            →
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="px-2.5 py-2 rounded border border-gray-200 bg-gray-50 text-[10px] text-gray-600 break-all leading-relaxed">
            {hash}
          </div>
        </div>
      </div>
      ...
      {/* status line */}
      <div className={cn('text-[10px] flex items-center gap-1.5', ok ? 'text-green-600' : 'text-red-600')}>
