...
Yes! Igris Overture is open source (MIT license). See [CONTRIBUTING.md](https://github.com/schlep-engine/schlep-engine/blob/main/CONTRIBUTING.md) for guidelines.
