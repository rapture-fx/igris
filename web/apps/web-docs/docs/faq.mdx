...
Yes! Igris Overture is open source (MIT license). See [CONTRIBUTING.md](https://github.com/Igris-inertial/system/blob/main/CONTRIBUTING.md) for guidelines.
...
- GitHub: [Report an issue](https://github.com/Igris-inertial/system/issues)
