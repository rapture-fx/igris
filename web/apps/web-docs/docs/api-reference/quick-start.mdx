...
Visit [console.schlep-engine.com](https://console.schlep-engine.com) and copy your API key.

## 2. Make Your First Request

```bash
curl https://api.schlep-engine.com/v1/chat/completions \
