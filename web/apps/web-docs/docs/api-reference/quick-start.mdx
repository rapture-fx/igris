...
client = OpenAI(
    base_url="https://overture.igrisinertial.com/v1",  # Changed
    api_key=os.environ['IGRIS_API_KEY']  # Your Igris key
)
...
const client = new OpenAI({
  baseURL: 'https://overture.igrisinertial.com/v1',  // Changed
...
config := openai.DefaultConfig(os.Getenv("IGRIS_API_KEY"))
config.BaseURL = "https://overture.igrisinertial.com/v1"  // Changed
