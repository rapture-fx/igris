...
```json
{
  "error": {
    ...
    "documentation_url": "https://github.com/Igris-inertial/docs"
  }
}
```
...
- **Python**: `pip install schlep-engine` - [github.com/Igris-inertial/igris-python-sdk](https://github.com/Igris-inertial/igris-python-sdk)
- **JavaScript/TypeScript**: `npm install @igris-inertial/javascript-sdk` - [github.com/Igris-inertial/igris-javascript-sdk](https://github.com/Igris-inertial/igris-javascript-sdk)
- **Go**: `go get github.com/Igris-inertial/igris-go-sdk` - [github.com/Igris-inertial/igris-go-sdk](https://github.com/Igris-inertial/igris-go-sdk)
- **Rust**: `cargo add schlep_engine` - [github.com/Igris-inertial/igris-rust-sdk](https://github.com/Igris-inertial/igris-rust-sdk)
- **Ruby**: `gem install schlep_engine` - [github.com/Igris-inertial/igris-ruby-sdk](https://github.com/Igris-inertial/igris-ruby-sdk)
- **Java**: Maven/Gradle support - [github.com/Igris-inertial/igris-java-sdk](https://github.com/Igris-inertial/igris-java-sdk)
- **C#**: NuGet package - [github.com/Igris-inertial/igris-csharp-sdk](https://github.com/Igris-inertial/igris-csharp-sdk)

See [SDK Documentation](/docs/api-reference/sdks) for detailed examples.
