...
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 16px; border-radius: 8px; margin: 16px 0;">
  <strong>🚀 v1.5.0 Enhancements (2025-12-12)</strong><br/>
  • <strong>+25% scoring accuracy</strong> via adaptive per-tenant reward weighting<br/>
  • <strong>50% faster convergence</strong> for new models with informed priors<br/>
  • <strong>+15% better decisions</strong> in first 50 requests with sparse data handling<br/>
  • <strong>Per-tenant learning</strong> adapts to your unique workload patterns
</div>
