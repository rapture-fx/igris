...
<div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); color: white; padding: 16px; border-radius: 8px; margin: 16px 0;">
  <strong>🚀 v1.5.0 Per-Tenant Learning (2025-12-12)</strong><br/>
  • <strong>Automatic weight optimization</strong> using gradient descent (α=0.05)<br/>
  • <strong>+20-25% scoring accuracy</strong> after 500+ requests per tenant<br/>
  • <strong>Zero configuration</strong> - learns your workload patterns automatically<br/>
  • <strong>Semantic-class specific</strong> - different weights for code vs chat vs analysis
</div>
