          ...
          <div className="flex-shrink-0 animate-fadeInUp py-4 bg-white dark:bg-[#0A0A0A]">
            <div className="max-w-4xl mx-auto px-8 pb-4">
              <div className="pl-4 pb-4 border-l border-gray-300 dark:border-[#f6f6f4]/10">
                <p className="text-[#85612c] dark:text-[#c5b0cd] mb-3 text-sm">## MACHINE_READABLE_DATA</p>
          ...
          <div className="max-w-4xl mx-auto space-y-6 p-8 pb-24">
            ...
            {visibleSections >= 2 && (
              <div className="animate-fadeInUp border-l border-gray-300 dark:border-[#f6f6f4]/10 pl-4">
                <p className="text-[#85612c] dark:text-[#c5b0cd] mb-3 text-sm">## THE CHALLENGE WE SOLVE</p>
            ...
            {visibleSections >= 3 && (
              <div className="animate-fadeInUp border-l border-gray-300 dark:border-[#f6f6f4]/10 pl-4">
                <p className="text-[#85612c] dark:text-[#c5b0cd] mb-3 text-sm">## 01. PRODUCT</p>
            ...
            {visibleSections >= 4 && (
              <div className="animate-fadeInUp border-l border-gray-300 dark:border-[#f6f6f4]/10 pl-4">
                <p className="text-[#85612c] dark:text-[#c5b0cd] mb-3 text-sm">## WHAT THIS IS</p>
            ...
            {visibleSections >= 5 && (
              <div className="animate-fadeInUp border-l border-gray-300 dark:border-[#f6f6f4]/10 pl-4">
                <p className="text-[#85612c] dark:text-[#c5b0cd] mb-3 text-sm">## 02. THE ARCHITECTURE</p>
            ...
            {visibleSections >= 6 && (
              <div className="animate-fadeInUp border-l border-gray-300 dark:border-[#f6f6f4]/10 pl-4">
                <p className="text-[#85612c] dark:text-[#c5b0cd] mb-3 text-sm">## 03. PROOF</p>
            ...
            {visibleSections >= 7 && (
              <div className="animate-fadeInUp border-l border-gray-300 dark:border-[#f6f6f4]/10 pl-4">
                <p className="text-[#85612c] dark:text-[#c5b0cd] mb-3 text-sm">## 04. DEPLOYMENT</p>
            ...
            {visibleSections >= 8 && (
              <div className="animate-fadeInUp border-l border-gray-300 dark:border-[#f6f6f4]/10 pl-4">
                <p className="text-[#85612c] dark:text-[#c5b0cd] mb-3 text-sm">## WHY IT EXISTS</p>
