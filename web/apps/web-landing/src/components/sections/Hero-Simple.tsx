    ...
    >
      <div className="mx-auto max-w-[1320px] px-4 sm:px-6 lg:px-8">
        <div className="px-2 md:px-4 lg:px-6">
          <div className="flex flex-col items-center text-center justify-end pt-40 md:pt-56 pb-16 md:pb-24">
            ...
            <p
              className="mt-6 text-gray-700 dark:text-[#c8c8b8] max-w-[62ch] mx-auto"
              style={{
                fontFamily: SANS,
            ...
            <div className="mt-9 flex flex-wrap items-center justify-center gap-x-3 gap-y-3">
              <a
