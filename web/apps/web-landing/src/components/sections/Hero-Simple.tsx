            ...
            <div className="pt-12 mb-6">
              <div className="flex flex-col md:flex-row md:justify-between md:items-start gap-6">
                <div className="text-left">
                  ...
                  <h2 className="text-base md:text-lg lg:text-xl font-medium text-[#666666] leading-[1.2] mt-2">
                    From routing decisions to execution guarantees
                  </h2>
                </div>
                <p className="text-sm md:text-base text-gray-700 max-w-md leading-relaxed text-left">
                  Igris provides decision control, governed execution, and verification across modern AI stacks.
                </p>
              </div>
            </div>
