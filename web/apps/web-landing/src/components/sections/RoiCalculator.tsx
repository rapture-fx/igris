            ...
            <div className="space-y-6">
              <div className="p-6 rounded-lg" style={{ backgroundColor: 'rgba(0, 0, 0, 0.02)' }}>
                <div className="text-center mb-4">
                  <p className="text-sm font-mono text-gray-600 mb-2">Based on provider cost optimization</p>
                  <p className="text-3xl font-mono" style={{ color: '#000000' }}>
                    {formatCurrency(results.minSavings)} - {formatCurrency(results.maxSavings)}
                  </p>
                  <p className="text-sm font-mono text-gray-600 mt-2">per month</p>
                </div>
              </div>

              <div className="space-y-3 pt-4 border-t" style={{ borderColor: 'rgba(156, 163, 175, 0.3)' }}>
                <div className="flex items-center justify-between">
                  <span className="text-base font-mono text-gray-700">Schlep-engine cost:</span>
                ...
                <div className="flex items-center justify-between pt-3 border-t" style={{ borderColor: 'rgba(156, 163, 175, 0.2)' }}>
                  <span className="text-base font-mono" style={{ color: '#000000' }}>Net monthly savings:</span>
                  <span className="text-lg font-mono" style={{ color: '#000000' }}>
                ...
                <div className="flex items-center justify-between">
                  <span className="text-base font-mono text-gray-700">ROI:</span>
                  <span className="text-lg font-mono" style={{ color: '#000000' }}>
          ...
          <div className="rounded-lg p-8" style={{
            ...
            <div className="space-y-4">
              <div className="p-4 rounded-lg" style={{ backgroundColor: 'rgba(0, 0, 0, 0.02)' }}>
                <p className="text-sm font-mono text-gray-700 mb-2">Provider cost optimization (30-60%)</p>
