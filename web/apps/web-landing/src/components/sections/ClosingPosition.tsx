        ...
        <LandingSurfaceFrame>
          <div className="landing-surface-panel flex flex-col items-center text-center px-6 md:px-16 py-20 md:py-32">
                ...
                <a
                  ...
                  className="mt-8 inline-flex items-center justify-center rounded-full bg-[#1b1912] px-6 py-3 text-[14px] font-medium text-[#f6f6f4] transition-opacity hover:opacity-80 dark:bg-[#f6f6f4] dark:text-[#1b1912]"
