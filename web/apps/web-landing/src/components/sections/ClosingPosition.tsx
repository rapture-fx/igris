      ...
      <div className="mx-auto max-w-[1200px] px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="pt-24 md:pt-40 pb-24 md:pb-40">
            ...
            >
              Give agents real work without losing control.
            </h3>
            <p
            ...
            <div className="mt-10 flex flex-wrap items-center gap-x-3 gap-y-3">
              <Link
                ...
                className="group inline-flex items-center gap-3 px-4 py-2.5 border border-gray-900 dark:border-[#f6f6f4] bg-gray-900 dark:bg-[#f6f6f4] text-[#f6f6f4] dark:text-[#1b1912] hover:opacity-85 transition-all duration-200"
