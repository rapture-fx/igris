      ...
      <div className="mx-auto max-w-[1300px] px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-6 md:mb-0 md:hidden text-left" style={{ paddingTop: '3rem', paddingBottom: '3rem' }}>
            ...
            <div className="space-y-8 text-left">
              ...
              <div className="border border-gray-300 dark:border-[#f6f6f4]/5 p-6 min-h-[350px] flex flex-col shadow-[0_0_10px_rgba(0,0,0,0.08)] dark:shadow-[0_0_15px_rgba(246,246,244,0.08)]">
                <h3 className="text-base mb-3 text-[#000000] dark:text-[#f6f6f4]" style={{ fontFamily: "'IBM Plex Mono', monospace", fontWeight: 400 }}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 flex-1">
              ...
              <div className="w-full space-y-8">
                ...
                <div className="border border-gray-300 dark:border-[#f6f6f4]/5 p-6 bg-[#f6f6f4] dark:bg-[#1b1912]/50 shadow-[0_0_10px_rgba(0,0,0,0.08)] dark:shadow-[0_0_15px_rgba(246,246,244,0.08)] flex flex-col">
                  ...
                  <button
                    ...
                    style={{ fontFamily: "'IBM Plex Mono', monospace", borderColor: 'rgba(20, 18, 10, 0.3)' }}
                  >
                    View Dashboard
                    <ChevronRight className="ml-1 h-3 w-3" />
                  </button>
            ...
            <div className="hidden md:flex md:col-span-1 md:border-l flex-col justify-start dark:border-[#f6f6f4]/5" style={{ paddingTop: '3rem', paddingBottom: '3rem', paddingLeft: '1rem' }}>
              ...
              <p className="text-xs md:text-sm text-gray-600 dark:text-[#a8a898] leading-relaxed" style={{ fontFamily: "'IBM Plex Mono', monospace", fontWeight: 400 }}>
