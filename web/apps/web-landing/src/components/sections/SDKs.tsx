...
const codeExamples: Record<Language, string[]> = {
  ...
  rust: [
    ...
    '        role: "user".into(),',
    '        content: "Summarize the latest task result.".into(),',
    '        ..Default::default()',
    '    }],',
    '    metadata: Some(std::collections::HashMap::from([("workflow".into(), "ops-review".into())])),',
    '    ..Default::default()',
    '})',
    '.await?;',
    '',
    ...
    'println!("{:?}", response.receipt.as_ref().and_then(|r| r.receipt_hash.as_ref()));',
  ],
}
