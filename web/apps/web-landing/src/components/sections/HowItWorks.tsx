...
export default function HowItWorks() {
  return (
    <section id="how-it-works" className="dark:bg-gray-900 text-gray-900 dark:text-white" style={{ backgroundColor: '#f6f6f4', height: '700px' }}>
        ...
        <div className="relative px-4 md:px-8 lg:px-12 flex flex-col" style={{
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 md:flex-1" style={{ height: '100%' }}>
            {/* Left Column - Content (2 columns wide) */}
             <div className="md:col-span-2 flex flex-col justify-start" style={{ paddingTop: '1rem', paddingBottom: '3rem', paddingRight: '1rem' }}>
