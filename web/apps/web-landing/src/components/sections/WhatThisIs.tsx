    ...
    <section className="bg-[#f6f6f4] dark:bg-dark-bg text-gray-900 dark:text-[#f6f6f4] transition-colors duration-200">
      <div className="mx-auto max-w-[1300px] px-4 sm:px-6 lg:px-8">
        <div className="relative px-4 md:px-8 lg:px-12 border-l border-r border-b border-gray-300 dark:border-[#f6f6f4]/10">
          {/* runtimeframe.png - light mode only */}
          {mounted && theme !== 'dark' && (
            <div className="absolute inset-2 pointer-events-none" style={{
              backgroundImage: 'url(/runtimeframe.png)',
          ...
          <div className="py-32 md:py-48 relative z-10">
            <div className="max-w-xl mx-auto bg-[#f6f6f4] dark:bg-[#1b1912] border border-gray-300 dark:border-[#f6f6f4]/5 p-8 md:p-16 rounded-lg shadow-[0_0_20px_rgba(0,0,0,0.15)] dark:shadow-[0_0_30px_rgba(246,246,244,0.15)]">
