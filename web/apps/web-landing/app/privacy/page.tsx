        ...
        <main className="pt-[70px]">
          <div className="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-16">
            <article className="prose prose-lg dark:prose-invert max-w-none">
              ...
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8 mb-4">Data We Do NOT Collect or Store</h2>
              ...
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8 mb-4">Data Processing (BYOK)</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-6">
              ...
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8 mb-4">Data We Do Collect</h2>
              <ul className="list-disc pl-6 text-gray-700 dark:text-gray-300 mb-6 space-y-2">
              ...
              <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8 mb-4">Security</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-6">
                We use AES-256 encryption, TLS 1.3, and regular security audits.
              </p>

              <h2 className="text-lg font-semibold text-gray-900 dark:text-white mt-8 mb-4">Your Rights</h2>
              <p className="text-gray-700 dark:text-gray-300 mb-6">
