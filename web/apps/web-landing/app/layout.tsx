...
export const metadata = {
  ...
  title: 'Reliable execution for AI agents.',
  description: 'Run consequential actions durably. Recover from infrastructure failures. Stop when the outcome is uncertain.',
  openGraph: {
    title: 'Reliable execution for AI agents.',
    description: 'Run consequential actions durably. Recover from infrastructure failures. Stop when the outcome is uncertain.',
