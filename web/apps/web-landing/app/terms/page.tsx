          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-16">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_250px] gap-16">
              ...
              <article className="prose prose-lg dark:prose-invert max-w-none">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">2.3 Igris Inertial Ownership</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-6">
                ...
                <h3 className="text-xl font-semibold text-gray-900 dark:text-white mt-6 mb-3">6.1 Igris Inertial Warranties</h3>
                <p className="text-gray-700 dark:text-gray-300 mb-6">
