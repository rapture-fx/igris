...
const sdkSupport = {
  ...
  native_sdk_note:
    'External Alpha first-class path is the Python durable SDK (distribution igris-sdk, import igris) via IgrisDurableClient. Other languages should call the hosted Actions HTTP API directly.',
  rows: [
    {
      language: 'Python',
      status: 'first-class',
      ...
      import: 'from igris import IgrisDurableClient',
      notes:
        'Supported durable Action client. Distribution name is igris-sdk; never pip install igris from public PyPI.',
    },
    {
      ...
      notes: 'Call the Actions HTTP API directly for External Alpha unless a durable JS client is explicitly published.',
    },
    {
      language: 'Go',
      status: 'http-api',
      ...
      install: 'Use any standard HTTP client',
      import: 'POST /v1/actions/:name/run on the hosted API',
      notes: 'Call the Actions HTTP API directly for External Alpha.',
    },
    {
      language: 'Rust',
      status: 'http-api',
    ...
    },
    {
      ...
      install: 'Use any standard HTTP client',
      import: 'POST /v1/actions/:name/run on the hosted API',
      notes: 'Call the Actions HTTP API directly.',
    },
    {
      language: 'C#',
      status: 'http-api',
  ...
  guides: [
    {
      ...
      title: 'MCP (Beta)',
      href: '/docs/mcp',
      summary: 'Beta MCP transport for discovering and calling registered Actions after the durable SDK path.',
    },
    {
      slug: 'first-durable-action',
      title: 'Your First Durable Action',
      href: '/docs/first-durable-action',
      summary: 'Bind one Action, submit a durable run, wait, and inspect Igris Run Proof.',
    },
    {
      slug: 'rest-api',
      title: 'REST API',
      href: '/docs/rest-api',
      summary: 'Language-neutral Actions HTTP API for durable runs and proof inspection.',
    },
    {
      slug: 'sdk',
      title: 'Python SDK',
      href: '/docs/sdk',
      summary: 'Install igris-sdk and use IgrisDurableClient for consequential durable Actions.',
    },
  ],
  methodGroups: [
    {
...
const rawApiSections = [
  ...
  },
  {
    ...
    endpoints: [
      ...
      {
        method: 'POST',
        path: '/v1/actions/runs/:id/approve',
        auth: 'Session cookie or igris_ API key',
        surface: 'Cloud API',
        stability: 'stable',
        description: 'Approves an action run that is paused awaiting approval and dispatches it for execution.',
      },
      {
        method: 'POST',
        path: '/v1/actions/runs/:id/reject',
        auth: 'Session cookie or igris_ API key',
        surface: 'Cloud API',
        stability: 'stable',
        description: 'Rejects an action run that is paused awaiting approval. The run is closed and never dispatched.',
      },
    ],
  },
  {
