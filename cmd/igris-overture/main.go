...
func main() {
	...
	if dbInstance != nil {
		...
		api.RegisterEvidenceRoutes(app, dbInstance)
		...
		log.Println("[Evidence] ✅ Embedded evidence ingestion endpoints registered (/v1/evidence/batches; embedded provenance only, grants no execution)")
