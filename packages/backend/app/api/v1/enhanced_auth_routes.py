"""
⚠️  DEPRECATED ENHANCED AUTHENTICATION ROUTES MODULE ⚠️
====================================================

This enhanced authentication routes module has been DEPRECATED and replaced by the unified authentication system.
...
import warnings
warnings.warn(
    "app.api.v1.enhanced_auth_routes is deprecated. Use app.api.v1.auth_unified instead.",
    DeprecationWarning,
    stacklevel=2
)
