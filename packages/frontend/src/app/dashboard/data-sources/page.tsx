...
import { Upload, Plus, Database, FileText, TrendingUp, Eye, Download, RefreshCw, Search, Filter } from 'lucide-react'
  ...
  return (
    <div className="p-6 sm:p-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Data Sources List */}
        <DataSourcesList searchTerm={searchTerm} filterType={filterType} />
