...
**TL;DR:** Igris Inertial is an OpenAI-compatible inference gateway with superpowers. One URL change, infinite providers.

```bash
curl https://api.igris-inertial.com/v1/chat/completions \
...
Igris Inertial provides **100% OpenAI-compatible** endpoints with enterprise-grade enhancements:

- **Drop-in replacement**: Change your base URL from `api.openai.com` to `api.igris-inertial.com`
...
```
Production:  https://api.igris-inertial.com/v1
Staging:     https://api-staging.igris-inertial.com/v1
Local:       http://localhost:8080/v1
```

## Quick Start

1. **Get your API key** from the [dashboard](https://console.igris-inertial.com)
2. **Change your base URL**:
   ```diff
   - https://api.openai.com/v1/chat/completions
   + https://api.igris-inertial.com/v1/chat/completions
   ```
3. **You're live** — your existing OpenAI SDK code works unchanged

## Schlep-Specific Extensions
...
<details>
<summary>Show all Schlep extensions</summary>
