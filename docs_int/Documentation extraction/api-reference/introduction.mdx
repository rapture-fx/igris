...
**TL;DR:** Schlep Engine is an OpenAI-compatible inference gateway with superpowers. One URL change, infinite providers.
...
Schlep Engine provides **100% OpenAI-compatible** endpoints with enterprise-grade enhancements:

- **Drop-in replacement**: Change your base URL from `api.openai.com` to `api.schlep-engine.com`
...
```
Production:  https://api.schlep-engine.com/v1
Staging:     https://api-staging.schlep-engine.com/v1
Local:       http://localhost:8080/v1
```

## Quick Start

1. **Get your API key** from the [dashboard](https://console.schlep-engine.com)
2. **Change your base URL**:
   ```diff
   - https://api.openai.com/v1/chat/completions
   + https://api.schlep-engine.com/v1/chat/completions
   ```
