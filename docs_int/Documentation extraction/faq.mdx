...
Igris Inertial **automatically fails over** to the next best provider in &lt;30 seconds. Your requests never fail.
...
Igris Inertial is an **AI routing and cost optimization platform** that sits between your app and multiple LLM providers. Instead of managing OpenAI, Anthropic, Google separately, you make one API call—Igris Inertial routes it to the best provider based on cost, speed, and quality.
...
Using Igris Inertial = automatic routing across OpenAI, Anthropic, Google, etc. with:
...
Igris Inertial is **100% OpenAI-compatible**. Use any OpenAI SDK (Python, Node.js, Go, etc.) with zero code changes beyond the base URL.
...
Your account will be paused. You can upgrade to Develop, Growth, or Scale tier anytime to continue using Igris Inertial.
...
No. **Scale tier is our highest public tier** with all features unlocked. For custom needs (air-gapped, white-label), contact sales@igris-inertial.com.
...
BYOK allows you to use **your own LLM provider API keys** instead of Igris Inertial's. Keys are:
...
Yes! Igris Inertial routes requests across all configured providers based on:
...
### What architecture does Igris Inertial use?

Igris Inertial uses a **hybrid polyglot architecture:**
...
### Can I self-host Igris Inertial?
...
Yes! Igris Inertial is a standard HTTP API:
...
### Where can I deploy Igris Inertial?

- **Cloud Hosted** - Managed by Igris Inertial (all tiers)
...
- **Documentation:** docs.igris-inertial.com
- **GitHub Issues:** github.com/igris-inertial/igris-inertial/issues
...
- GitHub Issues
- Email to support@igris-inertial.com
- Discord community
...
3. **Provider down** - Igris Inertial will auto-fallback to next provider
...
Yes! Igris Inertial is open source (MIT license). See [CONTRIBUTING.md](https://github.com/igris-inertial/igris-inertial/blob/main/CONTRIBUTING.md) for guidelines.
...
- GitHub: [Report an issue](https://github.com/igris-inertial/igris-inertial/issues)
