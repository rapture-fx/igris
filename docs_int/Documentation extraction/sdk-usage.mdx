...
Igris Inertial provides official SDKs for **Go**, **Python**, and **OpenAI-compatible** clients. All SDKs support intelligent routing with Thompson Sampling and EscapeVector Mode for zero-downtime resilience.
...
```bash
go get github.com/igris-inertial/igris-inertial/internal/sdk/go/igris
```
...
Igris Inertial is **OpenAI-compatible** - use any OpenAI SDK by changing the base URL.
...
# Point to Igris Inertial instead of OpenAI
client = OpenAI(
