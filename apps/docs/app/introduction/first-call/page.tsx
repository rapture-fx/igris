...
export default function FirstCallPage() {
  ...
  -H "Authorization: Bearer YOUR_API_KEY"`}</code></pre>
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-8 overflow-x-auto">
          <pre className="text-sm text-gray-900"><code>{JSON.stringify({
  "status": "healthy",
  "version": "1.0.0",
  "timestamp": "2024-01-15T10:30:00Z"
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6 overflow-x-auto">
          <pre className="text-sm text-gray-900"><code>{`name,age,email,city
John Doe,25,john@example.com,New York
Jane Smith,30,jane@example.com,Los Angeles
Bob Johnson,35,bob@example.com,Chicago`}</code></pre>
        </div>
  ...
  -F "name=My First Upload"`}</code></pre>
        </div>
  ...
  "created_at": "2024-01-15T10:35:00Z"
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6 overflow-x-auto">
          <pre className="text-sm text-gray-900"><code>{`curl -X GET "https://api.schlepengine.com/v1/uploads/upload_abc123/status" \\
  -H "Authorization: Bearer YOUR_API_KEY"`}</code></pre>
        </div>
...
print(f"Status: {status.processing_status}")`}</code></pre>
        </div>
...
console.log(\`Status: \${status.processingStatus}\`);</code></pre>
        </div>
