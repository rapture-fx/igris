...
client = se.Client.from_config()`}</code></pre>
        ...
        <div className="bg-blue-50 border-l-4 border-blue-400 p-6 mt-8">
          ...
          <div className="space-y-2">
            <a href="/use-cases/ml-training" className="block text-blue-600 hover:underline">→ ML Model Training Pipeline</a>
            <a href="/integrations/jupyter" className="block text-blue-600 hover:underline">→ Jupyter Notebook Integration</a>
            <a href="https://github.com/schlep-engine/python-examples" className="block text-blue-600 hover:underline">→ GitHub Examples Repository</a>
          </div>
        </div>
      </div>
    </div>
