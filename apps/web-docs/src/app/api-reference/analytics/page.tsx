...
export default function AnalyticsApiPage() {
  return (
    <div className="max-w-6xl mx-auto">
      <div className="mb-8">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">Analytics API</h1>
        <p className="text-xl text-gray-600">
          Track time savings, team productivity, and configure webhooks for real-time notifications.
        </p>
      </div>
