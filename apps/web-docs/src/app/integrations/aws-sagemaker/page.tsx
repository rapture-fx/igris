    ...
    scale_out_cooldown=60
        ...
        <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg mt-12">
          ...
          <ul className="space-y-2">
            ...
            <li><a href="/integrations/airflow" className="text-blue-600 dark:text-blue-400 hover:underline">→ Apache Airflow Integration</a></li>
            <li><a href="/advanced/monitoring" className="text-blue-600 dark:text-blue-400 hover:underline">→ Advanced Monitoring</a></li>
          </ul>
        </div>
      </div>
    </div>
