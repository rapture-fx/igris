...
const mainSections = [
  ...
  },
  {
    ...
    children: [
      ...
      { name: 'Financial Services AI', href: '/api-reference/financial-ai' },
      ...
      { name: 'E-commerce AI', href: '/api-reference/ecommerce-ai' },
      ...
      { name: 'Manufacturing AI', href: '/api-reference/manufacturing-ai' },
      { name: 'Predictive Maintenance', href: '/api-reference/manufacturing-ai#predictive-maintenance', method: 'POST' },
      { name: 'Quality Control', href: '/api-reference/manufacturing-ai#quality-control', method: 'POST' },
      { name: 'Supply Chain Optimization', href: '/api-reference/manufacturing-ai#supply-chain', method: 'POST' },
      { name: 'ML Pipeline', href: '/api-reference/ml-pipeline' },
      { name: 'Create ML Pipeline', href: '/api-reference/ml-pipeline#create-pipeline', method: 'POST' },
      { name: 'RL Hyperparameter Optimization', href: '/api-reference/ml-pipeline#rl-optimization', method: 'POST' },
