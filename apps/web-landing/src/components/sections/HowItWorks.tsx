...
export default function HowItWorks() {
  ...
  return (
    <section className="py-20 md:py-32 bg-gray-50 dark:bg-gray-900 border border-gray-400">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 border border-gray-400">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mb-20">
          ...
          <div className="relative space-y-8">
            ...
            {steps.map((step, index) => (
              <div 
                ...
                className={`group relative p-6 rounded-lg transition-all duration-300 hover:scale-[1.02] hover:bg-white dark:hover:bg-gray-800 hover:shadow-lg ${hoveredIndex !== null && hoveredIndex !== index ? 'opacity-50' : ''}`}
              >
                <div className="flex items-start space-x-4">
                  <div className="w-16 h-16 rounded-full flex items-center justify-center flex-shrink-0 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 z-10">
                    <span className="text-2xl font-bold text-gray-600 dark:text-gray-400">{index + 1}</span>
                  </div>
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      <span className="text-sm font-bold text-gray-600 dark:text-gray-400">Step {index + 1}</span>
                    </div>
          ...
          <div className="flex items-center justify-center">
            <pre className="bg-gray-800 dark:bg-gray-900 text-white p-4 rounded-lg overflow-x-auto w-full">
              <code>
