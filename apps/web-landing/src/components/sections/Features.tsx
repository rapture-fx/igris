  ...
  return (
    ...
    <section id="features" className="section-padding bg-white">
      <div className="max-w-7xl mx-auto container-padding">
        ...
        >
          {features.map((feature, index) => (
            <motion.div
              ...
              className="group relative bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 card-hover"
            >
        ...
        >
          <div className="bg-gradient-to-r from-soft-blue to-blue-600 rounded-2xl p-8 text-white">
