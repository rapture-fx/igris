...
export default function FAQ() {
  ...
  return (
    <section className="py-32 md:py-48 bg-[#111111] relative">
      <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: "url('/above the footer.svg')" }}></div>
      <div className="absolute inset-0 bg-gradient-to-b from-[#111111] via-transparent to-transparent pointer-events-none"></div>
