...
export default function Hero() {
  ...
  return (
    <>
    <section className="pt-20 pb-16 bg-black min-h-screen flex items-center relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        <div className="text-center">
          <h1 className="text-2xl md:text-4xl font-semibold text-white mb-4 leading-tight">
          ...
          <div className="flex justify-center gap-3">
            <Link
              href="#get-started"
              className="bg-[#0A2F4F] text-white px-6 py-2.5 rounded-md hover:bg-[#082740] transition-all duration-200 font-medium text-sm shadow-[inset_0_-1px_0_0_rgba(0,0,0,0.1),0_1px_3px_0_rgba(0,0,0,0.1)] hover:shadow-[inset_0_-1px_0_0_rgba(0,0,0,0.1),0_2px_6px_0_rgba(0,0,0,0.15)] backdrop-blur-sm"
            >
              Get Started for Free
            </Link>
            <Link
              href="http://localhost:3001"
              className="bg-gray-50 text-gray-900 border border-gray-300 px-6 py-2.5 rounded-md hover:bg-gray-100 hover:border-gray-400 transition-all duration-200 font-medium text-sm shadow-[inset_0_-1px_0_0_rgba(0,0,0,0.1),0_1px_3px_0_rgba(0,0,0,0.1)] hover:shadow-[inset_0_-1px_0_0_rgba(0,0,0,0.1),0_2px_6px_0_rgba(0,0,0,0.15)] backdrop-blur-sm"
            >
              API Documentation
            </Link>
          </div>
    ...
    <section className="py-20 bg-black">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div className="relative mx-auto max-w-8xl px-6">
          <div className="bg-gray-800 backdrop-blur-sm border border-gray-600 rounded-2xl px-6 py-4 shadow-sm">
            <div className="flex items-center justify-between mb-3">
              <div className="flex items-center space-x-2">
                <div className="w-2.5 h-2.5 bg-red-400 rounded-full"></div>
                <div className="w-2.5 h-2.5 bg-yellow-400 rounded-full"></div>
                <div className="w-2.5 h-2.5 bg-green-400 rounded-full"></div>
                <span className="ml-2 text-xs text-gray-300 font-medium">Terminal</span>
              </div>
              <button
            ...
            <div className="text-left">
              <div className="text-gray-800 dark:text-slate-200 font-mono text-sm leading-relaxed transition-colors duration-300">
                ...
                <div className="mb-2 ml-4 text-gray-400">-H "Authorization: Bearer your-api-key" \</div>
                <div className="mb-2 ml-4 text-gray-400">-F "files=@sales.csv,@support_calls.mp3,@logs.json" \</div>
                <div className="mb-2 ml-4 text-gray-400">-F "mode=realtime_stream" \</div>
                <div className="mb-4 ml-4 text-gray-400">-F "auto_ml=production_ready"</div>
