    ...
    <section className="relative min-h-screen overflow-hidden bg-white pt-32 pb-16">
      ...
      <div className="relative z-20 mx-auto max-w-[1300px] px-4 sm:px-6 lg:px-8">
        <div className="text-center pt-20">
          <h1 className="text-3xl md:text-4xl font-semibold text-gray-900 mb-2 leading-tight py-8 text-center">
          ...
          <div className="flex justify-center gap-3">
            <Link
              href="/dashboard"
              className="inline-flex items-center justify-center bg-black text-white px-5 py-2.5 rounded-xl hover:bg-gray-800 transition-all duration-200 font-medium text-sm shadow-md hover:shadow-lg"
            >
