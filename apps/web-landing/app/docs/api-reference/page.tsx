            ...
            <div className="max-w-4xl mx-auto">
              ...
              <section className="mb-12">
                ...
                <div className="bg-gray-50 rounded-lg p-4 mb-6">
                  <code className="text-lg font-mono text-gray-900">https://api.schlep-engine.com</code>
                </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div>
                      <h3 className="text-lg font-semibold text-gray-900 mb-2">
                        <Link href="/docs/api-reference/upload" className="hover:text-blue-600">
                          Data Upload
                        </Link>
                      </h3>
              ...
              <section className="mb-12">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  >
                    ...
                    <p className="text-gray-600">
                      Connect with Jupyter, AWS SageMaker, and other popular platforms.
                    </p>
                  </Link>
                </div>
              </section>
