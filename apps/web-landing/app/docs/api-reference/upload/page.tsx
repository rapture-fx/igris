  ...
  "error": {
    ...
    "details": {
      ...
      "max_size": 104857600
                  ...
                  examples={{
                    curl: `curl -X POST https://api.schlep-engine.com/v1/upload \\
...
fetch('https://api.schlep-engine.com/v1/upload', {
  method: 'POST',
  headers: {
    'Authorization': 'Bearer sk_test_4eC39HqLyjWDarjtT1zdp7dc'
  },
  ...
  "data": {
    ...
    "pagination": {
      ...
      "has_more": true
                  ...
                  examples={{
                    curl: `curl -X GET "https://api.schlep-engine.com/v1/uploads?limit=10&status=completed" \\
  -H "Authorization: Bearer sk_test_4eC39HqLyjWDarjtT1zdp7dc"`,
                    python: `import requests

response = requests.get(
    'https://api.schlep-engine.com/v1/uploads',
...
fetch(\`https://api.schlep-engine.com/v1/uploads?\${params}\`, {
  headers: {
    'Authorization': 'Bearer sk_test_4eC39HqLyjWDarjtT1zdp7dc'
  }
})
...
.then(data => {
  ...
  "error": {
    ...
    "code": "upload_not_found"
                  ...
                  examples={{
                    curl: `curl -X GET https://api.schlep-engine.com/v1/uploads/upload_1234567890 \\
  -H "Authorization: Bearer sk_test_4eC39HqLyjWDarjtT1zdp7dc"`,
                    python: `import requests

response = requests.get(
    'https://api.schlep-engine.com/v1/uploads/upload_1234567890',
    headers={'Authorization': 'Bearer sk_test_4eC39HqLyjWDarjtT1zdp7dc'}
)
...
if response.status_code == 200:
    ...
    print(f"Error: {response.text}")`,
                    javascript: `fetch('https://api.schlep-engine.com/v1/uploads/upload_1234567890', {
  headers: {
    'Authorization': 'Bearer sk_test_4eC39HqLyjWDarjtT1zdp7dc'
  }
})
...
.then(data => {
  ...
  "error": {
    ...
    "code": "upload_not_found"
                  ...
                  examples={{
                    curl: `curl -X DELETE https://api.schlep-engine.com/v1/uploads/upload_1234567890 \\
  -H "Authorization: Bearer sk_test_4eC39HqLyjWDarjtT1zdp7dc"`,
                    python: `import requests
