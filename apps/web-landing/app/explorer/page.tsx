  ...
  useEffect(() => {
    ...
    const mockPreview: DataPreview = {
      ...
      rows: [
        ...
        ['CUST_006', '2024-01-13', 78.25, 'Food', 'Debit Card', false],
        ['CUST_007', '2024-01-12', 199.99, 'Electronics', 'PayPal', true],
        ['CUST_008', '2024-01-12', 45.00, 'Clothing', 'Credit Card', false]
      ],
      total_count: 150000
    }
                    ...
                    <div className="flex items-center space-x-2">
                      <button 
                        ...
                        className={`p-2 border rounded-lg transition-colors ${
                          viewMode === 'table' 
                            ? 'bg-[#468BE6] border-[#468BE6] text-white' 
                            : 'bg-[#0f0f0f] border-gray-700 text-gray-400 hover:bg-gray-900'
                        }`}
                      >
