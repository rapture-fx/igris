...
mod tests {
    ...
    fn receipt_hash_chaining() {
        ...
        let r1 = ExecutionReceipt::new("a1", 10, 20, 5, 0, 3, false, "", Some(&sk));
        let r2 = ExecutionReceipt::new("a1", 15, 25, 5, 100, 5, false, &r1.hash, Some(&sk));
    ...
    async fn receipt_log_append_and_chain() {
        ...
        let r2 = log.append("ag", 15, 30, 5, 0, 3, false).await.unwrap();
