...
(cd apps/web-landing && export PATH=$PATH:../../node_modules/.bin && pnpm run dev > ../web-landing/landing.log 2>&1) &
LANDING_PID=$!

# Start console
echo "Starting console on port 3004..."
(cd apps/web-console && export PATH=$PATH:../../node_modules/.bin && pnpm run dev > ../web-console/console.log 2>&1) &
CONSOLE_PID=$!

# Start docs
echo "Starting docs on port 3005..."
(cd apps/web-docs && export PATH=$PATH:../../node_modules/.bin && pnpm run dev > ../web-docs/docs.log 2>&1) &
DOCS_PID=$!
