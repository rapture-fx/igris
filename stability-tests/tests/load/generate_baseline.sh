...
cat > "$OUTPUT_FILE" <<'EOF'
# Igris Inertial Performance Baseline Report
...
This document establishes the performance baseline for Igris Inertial v1.0.0 based on extended load testing and soak testing conducted in Phase 4.1.
...
*Generated by Igris Inertial Phase 4.1 Performance Baseline Generator*
EOF
