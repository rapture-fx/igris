...
var routeManifestRules = []routeManifestRule{
	...
	},
	{
		...
		Meta: RouteManifestMetadata{
			...
			Notes:                  "BETA: Agent-facing MCP JSON-RPC endpoint that reuses the durable Action Task boundary; not independently proven through a complete external-alpha MCP journey",
		},
	},
	{
		...
		Meta: RouteManifestMetadata{
			...
			Classification:         "experimental_non_core",
			DefaultExposure:        "disabled_by_default",
			AuthExpectation:        "BetterAuth tenant credential",
			TenantScopeExpectation: "tenant-owned registered action installs",
			FeatureFlag:            ExperimentalActionPacksRoutesFlag,
			Notes:                  "Built-in Action Pack install (registered actions only); disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/action-packs",
		Meta: RouteManifestMetadata{
			...
			TenantScopeExpectation: "tenant credential required",
			FeatureFlag:            ExperimentalActionPacksRoutesFlag,
			Notes:                  "Built-in Action Pack catalog; disabled in external-alpha defaults",
		},
	},
	{
		Method: "GET",
	...
	},
	{
		...
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalExecutionIntelligenceRoutesFlag,
			Notes:                  "Execution Intelligence metrics; disabled in external-alpha defaults",
		},
	},
	{
		...
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalExecutionIntelligenceRoutesFlag,
			Notes:                  "Execution affinity aggregates; disabled in external-alpha defaults",
		},
	},
	{
		...
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalExecutionIntelligenceRoutesFlag,
			Notes:                  "Trust recommendations; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/execution/trust-recommendations/*",
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalExecutionIntelligenceRoutesFlag,
			Notes:                  "Trust recommendation lifecycle; disabled in external-alpha defaults",
		},
	},
	{
		...
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalExecutionIntelligenceRoutesFlag,
			Notes:                  "Execution evals; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/execution-evals",
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalExecutionIntelligenceRoutesFlag,
			Notes:                  "Execution evaluation CRUD; disabled in external-alpha defaults",
		},
	},
	{
		...
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalPolicySimulationRoutesFlag,
			Notes:                  "Policy proposals; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/policy/proposals/*",
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalPolicySimulationRoutesFlag,
			Notes:                  "Policy proposal detail; disabled in external-alpha defaults",
		},
	},
	{
		...
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalPolicySimulationRoutesFlag,
			Notes:                  "Policy simulation; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/execution/governance/*",
		Meta: RouteManifestMetadata{
			RouteGroup:             "execution_governance",
			RegistrationSource:     "RegisterGovernanceRoutes",
			Classification:         "core_public_product_api",
			DefaultExposure:        "authenticated",
			AuthExpectation:        "BetterAuth tenant credential",
			TenantScopeExpectation: "tenant-bound recovery-event inspection",
			Notes:                  "Durable Action recovery-event inspection for safe Runtime recovery",
		},
	},
	{
		Path: "/v1/execution/shadow",
		Meta: RouteManifestMetadata{
			RouteGroup:             "execution_shadow",
			RegistrationSource:     "RegisterExecutionRoutes",
			Classification:         "experimental_non_core",
			DefaultExposure:        "disabled_by_default",
			AuthExpectation:        "BetterAuth tenant credential",
			TenantScopeExpectation: "tenant-bound shadow traces",
			FeatureFlag:            ExperimentalRoutingRoutesFlag,
			Notes:                  "Shadow execution traces; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/execution/*",
		Meta: RouteManifestMetadata{
			...
			DefaultExposure:        "authenticated",
			AuthExpectation:        "BetterAuth tenant credential",
			TenantScopeExpectation: "tenant-bound durable execution-run inspection",
			Notes:                  "Execution run inspection used by Action Task recovery proofs; BT-state/shadow remain flag-gated",
		},
	},
	{
		Path: "/v1/agents",
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalAgentRegistryRoutesFlag,
			Notes:                  "Agent registry; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/agents/:id/bt-state",
		Meta: RouteManifestMetadata{
			RouteGroup:             "execution_bt_state",
			RegistrationSource:     "RegisterExecutionRoutes",
			Classification:         "experimental_non_core",
			DefaultExposure:        "disabled_by_default",
			AuthExpectation:        "BetterAuth tenant credential",
			TenantScopeExpectation: "tenant-bound BT live state",
			FeatureFlag:            ExperimentalRoboticsRoutesFlag,
			Notes:                  "BT live-view; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/agents/:id/bt-state/stream",
		Meta: RouteManifestMetadata{
			RouteGroup:             "execution_bt_state",
			RegistrationSource:     "RegisterExecutionRoutes",
			Classification:         "experimental_non_core",
			DefaultExposure:        "disabled_by_default",
			AuthExpectation:        "BetterAuth tenant credential",
			TenantScopeExpectation: "tenant-bound BT live state stream",
			FeatureFlag:            ExperimentalRoboticsRoutesFlag,
			Notes:                  "BT live-view stream; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/agents/*",
		Meta: RouteManifestMetadata{
			...
			DefaultExposure:        "disabled_by_default",
			AuthExpectation:        "BetterAuth tenant credential",
			TenantScopeExpectation: "tenant-bound registry CRUD",
			FeatureFlag:            ExperimentalAgentRegistryRoutesFlag,
			Notes:                  "Agent registry detail; disabled in external-alpha defaults",
		},
	},
	{
		...
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalEvidenceMemoryRoutesFlag,
			Notes:                  "Evidence Memory; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/policies/*",
