...
var routeManifestRules = []routeManifestRule{
	...
	},
	{
		Path: "/v1/execution/*",
		Meta: RouteManifestMetadata{
			RouteGroup:             "execution_console",
			RegistrationSource:     "RegisterExecutionRoutes",
			Classification:         "experimental_non_core",
			DefaultExposure:        "disabled_by_default",
			AuthExpectation:        "BetterAuth tenant credential",
			TenantScopeExpectation: "tenant-bound legacy execution inspection",
			FeatureFlag:            ExperimentalExecutionConsoleRoutesFlag,
			Notes:                  "Legacy inference-era execution console; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/agents",
	...
	},
	{
		...
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalAgentRegistryRoutesFlag,
			Notes:                  "Agent registry detail and BT-state; disabled in external-alpha defaults (BT-state also requires execution console flag at registration time)",
		},
	},
	{
	...
	},
	{
		...
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalExecutionConsoleRoutesFlag,
			Notes:                  "Legacy execution policy assignment; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/policies",
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalExecutionConsoleRoutesFlag,
			Notes:                  "Legacy execution policy listing; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/alerts/*",
		Meta: RouteManifestMetadata{
			...
			FeatureFlag:            ExperimentalExecutionConsoleRoutesFlag,
			Notes:                  "Legacy execution alert stream; disabled in external-alpha defaults",
		},
	},
	{
		Path: "/v1/api-keys/*",
