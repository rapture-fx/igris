// Package metrics provides Prometheus metrics for Schlep-Engine
package metrics
...
var (
	...
	TelemetryDropped = promauto.NewCounter(prometheus.CounterOpts{
		Name: "schlep_telemetry_dropped_total",
	...
	TelemetryLatency = promauto.NewHistogram(prometheus.HistogramOpts{
		Name:    "schlep_telemetry_latency_seconds",
	...
	RoutingErrors = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "schlep_routing_errors_total",
	...
	ProviderRequests = promauto.NewCounterVec(
		prometheus.CounterOpts{
			Name: "schlep_provider_requests_total",
	...
	ProviderLatency = promauto.NewHistogramVec(
		prometheus.HistogramOpts{
			Name:    "schlep_provider_latency_seconds",
