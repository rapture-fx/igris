"""
Configuration management for Igris-engine CLI.
"""
...
@dataclass
class Config:
    """Configuration class for Igris-engine CLI."""
    
    # API Configuration
    api_key: Optional[str] = None
    base_url: str = "https://api.igris-inertial.com"
    timeout: int = 30
    ...
    def _load_from_env(self):
        ...
        env_mappings = {
            'IGRIS_API_KEY': 'api_key',
            'IGRIS_BASE_URL': 'base_url',
            'IGRIS_TIMEOUT': 'timeout',
            'IGRIS_VERIFY_SSL': 'verify_ssl',
            'IGRIS_DEFAULT_FORMAT': 'default_format',
            'IGRIS_PARALLEL_JOBS': 'parallel_jobs',
            'IGRIS_AUTO_CLEAN': 'auto_clean',
            'IGRIS_CHUNK_SIZE': 'chunk_size',
            'IGRIS_OUTPUT_DIR': 'output_dir',
            'IGRIS_LOG_LEVEL': 'log_level',
            'IGRIS_SHOW_PROGRESS': 'show_progress',
            'IGRIS_PIPELINE_TIMEOUT': 'pipeline_timeout',
            'IGRIS_RETRY_ATTEMPTS': 'retry_attempts',
            'IGRIS_RETRY_DELAY': 'retry_delay',
        }
