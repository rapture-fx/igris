"""
Main Igris-engine SDK Client

Official Python client for the Igris-engine API platform.
"""
...
from ..exceptions.base import ConfigurationError, IgrisError
...
class IgrisClient(LoggerMixin):
    """
    Main client class for the Igris-engine Python SDK.
    
    This client provides access to all Igris-engine API endpoints with
    ...
    def __init__(
        ...
        self.logger.info(f"Igris-engine client initialized with base URL: {self.base_url}")
    ...
    async def close(self):
        ...
        self.logger.info("Igris-engine client closed")
...
class IgrisClientSync:
    """
    Synchronous wrapper for IgrisClient.
    ...
    def __init__(self, **kwargs):
        ...
        self._async_client = IgrisClient(**kwargs)
        self._loop = None
