"""
Base exception classes for Schlep-engine SDK
"""
...
class SchlepEngineError(Exception):
    """Base exception class for all Schlep-engine SDK errors."""
...
class NetworkError(SchlepEngineError):
...
class ConfigurationError(SchlepEngineError):
