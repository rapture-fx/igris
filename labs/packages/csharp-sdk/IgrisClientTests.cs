...
namespace Igris.Tests;

/// <summary>
/// Unit tests for IgrisClient.
/// </summary>
public class IgrisClientTests : IDisposable
{
    private readonly Mock<HttpMessageHandler> _httpMessageHandlerMock;
    private readonly HttpClient _httpClient;
    private readonly Mock<ILogger<IgrisClient>> _loggerMock;
    private readonly JsonSerializerOptions _jsonOptions;

    public IgrisClientTests()
    {
        _httpMessageHandlerMock = new Mock<HttpMessageHandler>();
        _httpClient = new HttpClient(_httpMessageHandlerMock.Object);
        _loggerMock = new Mock<ILogger<IgrisClient>>();
    ...
    public async Task UploadAsync_Success_ReturnsUploadResponse()
    {
        ...
        using var client = new IgrisClient("test-api-key", "https://api.test.com/v1", _httpClient, _loggerMock.Object);
    ...
    public async Task DeployAsync_Success_ReturnsDeployResponse()
    {
        ...
        var expectedResponse = new DeployResponse
        {
            ...
            EndpointUrl = "https://api.igris-inertial.com/models/model_789/predict",
            Status = "deployed",
        ...
        Assert.Equal("https://api.igris-inertial.com/models/model_789/predict", result.EndpointUrl);
    ...
    public async Task ApiCall_InvalidApiKey_ThrowsApiException()
    {
        ...
        using var client = new IgrisClient("invalid-key", "https://api.test.com/v1", _httpClient, _loggerMock.Object);
    ...
    {
        // Act & Assert
        Assert.Throws<ConfigurationException>(() => new IgrisClient(""));
        Assert.Throws<ConfigurationException>(() => new IgrisClient(null!));
        Assert.Throws<ConfigurationException>(() => new IgrisClient("   "));
    }
    ...
    {
        // Arrange
        Environment.SetEnvironmentVariable("IGRIS_API_KEY", null);

        // Act & Assert
        Assert.Throws<ConfigurationException>(() => IgrisClient.FromEnvironment());
    }
    ...
    {
        // Arrange
        Environment.SetEnvironmentVariable("IGRIS_API_KEY", "test-key");

        try
        {
            // Act
            using var client = IgrisClient.FromEnvironment(_httpClient, _loggerMock.Object);

            // Assert
            Assert.NotNull(client);
            Assert.Equal("https://api.igris-inertial.com/v1", client.BaseUrl);
        }
        finally
        {
            Environment.SetEnvironmentVariable("IGRIS_API_KEY", null);
