 ...
 * @since 1.0.0
 */
class IgrisClientTest {

    private MockWebServer mockWebServer;
    private IgrisClient client;
    ...
    void setUp() throws IOException, ConfigurationException {
        ...
        client = new IgrisClient("test-api-key", baseUrl);
    ...
    void testDeployReturnsEndpoint() throws Exception {
        ...
        DeployResponse expectedResponse = new DeployResponse()
            ...
            .setEndpointUrl("https://api.igris-inertial.com/models/model_789/predict")
            .setStatus("deployed")
        ...
        assertEquals("https://api.igris-inertial.com/models/model_789/predict", response.getEndpointUrl());
    ...
    void testClientCreationFromEnv() throws Exception {
        ...
        System.setProperty("IGRIS_API_KEY", "env-api-key");
        try {
            ...
            System.clearProperty("IGRIS_API_KEY");
        }
    }
