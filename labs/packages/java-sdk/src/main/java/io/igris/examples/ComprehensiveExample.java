package io.igris.examples;

import io.igris.IgrisClient;
import io.igris.api.*;
import io.igris.exceptions.ApiException;
import io.igris.exceptions.ConfigurationException;
...
/**
 * Comprehensive example demonstrating all Igris-engine SDK API clients.
 *
...
public class ComprehensiveExample {
    ...
    public static void main(String[] args) {
        try {
            ...
            IgrisClient client = new IgrisClient("your-api-key-here");

            System.out.println("=== Igris-engine Java SDK - Comprehensive Example ===\n");
    ...
    private static void demonstrateDataProcessing(IgrisClient client)
    ...
    private static void demonstrateMLPipeline(IgrisClient client)
            throws ApiException, IOException {
    ...
    private static void demonstrateAnalytics(IgrisClient client)
            throws ApiException, IOException {
    ...
    private static void demonstrateDocumentExtraction(IgrisClient client)
            throws ApiException, IOException {
    ...
    private static void demonstrateDataQuality(IgrisClient client)
            throws ApiException, IOException {
    ...
    private static void demonstrateStorage(IgrisClient client)
            throws ApiException, IOException {
    ...
    private static void demonstrateMonitoring(IgrisClient client)
            throws ApiException, IOException {
    ...
    private static void demonstrateUsers(IgrisClient client)
            throws ApiException, IOException {
    ...
    private static void demonstrateAdmin(IgrisClient client)
            throws ApiException, IOException {
