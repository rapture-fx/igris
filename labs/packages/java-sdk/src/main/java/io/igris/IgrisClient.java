 ...
 * <ul>
 *   <li>As a parameter when creating the client: {@code new IgrisClient("your-api-key")}</li>
 *   <li>Via the {@code IGRIS_API_KEY} environment variable</li>
 * </ul>
 *
 * <h3>Example Usage</h3>
 * <pre>{@code
...
public class IgrisClient {
    private static final Logger logger = LoggerFactory.getLogger(IgrisClient.class);

    public static final String DEFAULT_BASE_URL = "https://api.igris-inertial.com/v1";
     ...
     *
     * @param apiKey Your Igris-engine API key
     * @throws ConfigurationException if the API key is null or empty
     */
    public IgrisClient(String apiKey) throws ConfigurationException {
     ...
     * @throws ConfigurationException if the API key is null or empty
     */
    public IgrisClient(String apiKey, String baseUrl) throws ConfigurationException {
        if (apiKey == null || apiKey.trim().isEmpty()) {
        ...
        logger.debug("IgrisClient initialized with base URL: {}", baseUrl);
    }
    ...
    public void close() {
        ...
        logger.debug("IgrisClient closed");
    }
}