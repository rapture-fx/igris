...
/**
 * Basic usage example for the Igris-engine Java SDK.
 *
...
public class BasicUsageExample {
    ...
    public static void runExample() throws ConfigurationException, ApiException, IOException, InterruptedException {
        logger.info("🚀 Igris-engine Java SDK Example");
        logger.info("==================================");
        ...
        IgrisClient client;
        try {
            client = IgrisClient.fromEnv();
        } catch (ConfigurationException e) {
            logger.warn("IGRIS_API_KEY environment variable not set. Using placeholder.");
            logger.info("Set your API key: export IGRIS_API_KEY=your-api-key-here");
            return;
        }
