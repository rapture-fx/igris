...
func (m *L2CacheMetrics) GetMetrics() []Metric {
	...
	return []Metric{
		{
			Name:   "schlep_l2_cache_hits_total",
			Type:   "counter",
		...
		{
			Name:   "schlep_l2_cache_misses_total",
			Type:   "counter",
		...
		{
			Name:   "schlep_l2_cache_evictions_total",
			Type:   "counter",
		...
		{
			Name:   "schlep_l2_cache_get_latency_seconds",
			Type:   "gauge",
		...
		{
			Name:   "schlep_l2_cache_set_latency_seconds",
			Type:   "gauge",
