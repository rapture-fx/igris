...
PASS
ok  	github.com/schlep-engine/sdk-go/schlep	3.118s
```
...
### Package Metadata ✅
- Module name: `github.com/schlep-engine/sdk-go`
- Version: `v1.0.0-rc1`
- License: MIT
...
### Ready for go get ✅
```bash
go get github.com/schlep-engine/sdk-go@v1.0.0-rc1
```
...
- Ready for publication as `github.com/schlep-engine/sdk-go`
